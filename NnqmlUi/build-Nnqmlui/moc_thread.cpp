...
QT_MOC_LITERAL(1, 10, 10), // "netTrained"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "netThread\0netTrained\0"
};
...
void netThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->netTrained(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (netThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&netThread::netTrained)) {
                *result = 0;
                return;
            }
        }
