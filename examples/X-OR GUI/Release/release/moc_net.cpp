...
QT_MOC_LITERAL(1, 4, 12), // "errorOccured"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 5), // "netID"
QT_MOC_LITERAL(4, 24, 6), // "Error&"
QT_MOC_LITERAL(5, 31, 1), // "e"
QT_MOC_LITERAL(6, 33, 13), // "onNeuronError"
QT_MOC_LITERAL(7, 47, 8), // "NeuronID"
QT_MOC_LITERAL(8, 56, 2) // "ID"

    },
    "Net\0errorOccured\0\0netID\0Error&\0e\0"
    "onNeuronError\0NeuronID\0ID"
};
...
void Net::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onNeuronError((*reinterpret_cast< NeuronID(*)>(_a[1])),(*reinterpret_cast< Error(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Net::*)(unsigned int , Error & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Net::errorOccured)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Net::errorOccured(unsigned int _t1, Error & _t2)
{
