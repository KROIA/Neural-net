...
geometryPath = inc#$$QT_work_dir/Rect-master\Rect-master
rectPath     = bin#$$QT_work_dir/DLL/Rect
configPath   = bin#$$QT_work_dir/DLL/Config
LIBS+=bin/Rect.dll \
      bin/Config.dll
